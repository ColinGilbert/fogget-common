 ...
 *  */
    public static ArduinoConfigChangeRepresentation validate(ArduinoConfigChangeRepresentation arg, int currentLightsOnHour, int currentLightsOnMin, int currentLightsOffHour, int currentLightsOffMin) {
        ArduinoConfigChangeRepresentation req = arg;
